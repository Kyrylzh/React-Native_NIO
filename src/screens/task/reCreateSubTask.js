...
class ReCreateSubTask extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchTerm: "",
  ...
  componentWillMount() {
    console.log("componentWillMount Re Create Sub Task");
  }
  ...
  async requestCreateSubTask() {
    ...
    if (subtask === "") {
      ...
      this.props.navigation.navigate("ReCreateSubTaskUses");
    }
  }
...
export default ReCreateSubTask;
